---
title: "Parameter calibration (P-Model) to multiple targets (GPP, bigD13C) QUARTO"
author: "Josefa Arán, Fabian Bernhard"
format: 
  html:
    code-fold: show
vignette: >
  %\VignetteIndexEntry{Parameter calibration (P-Model) to multiple targets (GPP, bigD13C) QUARTO}
...
```{r prepare multisite/multitarget calibration setups, eval = FALSE} 
